...
EXCEPTION
    WHEN OTHERS THEN
        dbms_output.put_line(SQLERRM);
        dbms_output.put_line('Please provide the correct values according to the signature given in ALL_ACTIONS..Ensure that the deal ID is valid and you are the owner of the listing');
        rollback;
        raise;
END ACCEPT_DEAL;
END DEAL;
