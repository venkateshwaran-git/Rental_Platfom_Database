...
SELECT count(*) into nCount FROM dba_tables where table_name = 'PEOPLE';
IF(nCount > 0)
THEN
...
SELECT count(*) into nCount FROM dba_tables where table_name = 'LISTING_CATEGORY';
IF(nCount > 0)
THEN
...
--RENTAL BASIS
SELECT count(*) into nCount FROM dba_tables where table_name = 'RENTAL_BASIS';
IF(nCount > 0)
THEN
...
--ADDRESS COUNTRY
SELECT count(*) into nCount FROM dba_tables where table_name = 'ADDRESS_COUNTRY';
IF(nCount > 0)
THEN
...
--ADDRESS STATE
SELECT count(*) into nCount FROM dba_tables where table_name = 'ADDRESS_STATE';
IF(nCount > 0)
THEN
...
--ADDRESS CITY
SELECT count(*) into nCount FROM dba_tables where table_name = 'ADDRESS_CITY';
IF(nCount > 0)
THEN
...
--USER_ADDRESS
SELECT count(*) into nCount FROM dba_tables where table_name = 'USER_ADDRESS';
IF(nCount > 0)
THEN
...
--LISTINGS
SELECT count(*) into nCount FROM dba_tables where table_name = 'LISTINGS';
IF(nCount > 0)
THEN
...
SELECT count(*) into nCount FROM dba_tables where table_name = 'CURRENT_STATUS';
IF(nCount > 0)
THEN
...
SELECT count(*) into nCount FROM dba_tables where table_name = 'DEAL_STATUS';
IF(nCount > 0)
THEN
...
SELECT count(*) into nCount FROM dba_tables where table_name = 'DESIGNATION';
IF(nCount > 0)
THEN
...
SELECT count(*) into nCount FROM dba_tables where table_name = 'DEALS';
IF(nCount > 0)
THEN
...
ELSE
  ...
  PRIMARY KEY(DEALS_ID)
   ...
   EXECUTE IMMEDIATE 'INSERT INTO DEALS(PRICE,STATUS_ID,LISTING_ID,USER_ID,START_DATE,END_DATE) 
    VALUES(25,(SELECT STATUS_ID FROM DEAL_STATUS WHERE STATUS_NAME=''PENDING''),
    (SELECT LISTING_ID FROM LISTINGS WHERE TITLE=''Camera'' AND ROWNUM=1),(SELECT USER_ID FROM PEOPLE WHERE USERNAME=''VIKRAM11''),
    TO_TIMESTAMP(''05-AUG-20 10:00:00 AM''),TO_TIMESTAMP(''10-AUG-20 10:00:00 AM''))'; 
...
SELECT count(*) into nCount FROM dba_tables where table_name = 'EMPLOYEE_ADDRESS';
IF(nCount > 0)
THEN
...
SELECT count(*) into nCount FROM dba_tables where table_name = 'ORDER_STATUS';
IF(nCount > 0)
THEN
...
ELSE
  ...
  PRIMARY KEY(ORDER_ID)
    ...
    EXECUTE IMMEDIATE 'INSERT INTO ORDER_STATUS(STATUS_ID,DEALS_ID,EMPLOYEE_ID) VALUES(1,1,1)';
